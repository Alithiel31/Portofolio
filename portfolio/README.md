...
2. Attendre que la BDD soit prête (healthcheck)
3. Exécuter les migrations Prisma
4. Seeder avec des données de démo
5. Lancer le backend sur **http://localhost:3000**
6. Lancer le frontend Vite sur **http://localhost:5173**

### Option B — sans Docker (PostgreSQL local requis)

```bash
# PostgreSQL doit tourner localement
cp backend/.env.example backend/.env
# Éditer DATABASE_URL dans backend/.env
